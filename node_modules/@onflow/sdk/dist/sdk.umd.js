(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@onflow/util-logger'), require('@onflow/util-invariant'), require('uuid'), require('@onflow/typedefs'), require('@onflow/config'), require('@onflow/rlp'), require('@onflow/util-address'), require('events'), require('@onflow/transport-http'), require('sha3'), require('@onflow/util-template'), require('@onflow/types')) :
  typeof define === 'function' && define.amd ? define(['exports', '@onflow/util-logger', '@onflow/util-invariant', 'uuid', '@onflow/typedefs', '@onflow/config', '@onflow/rlp', '@onflow/util-address', 'events', '@onflow/transport-http', 'sha3', '@onflow/util-template', '@onflow/types'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.onflowSdk = {}, global.logger, global.utilInvariant, global.uuid, global.typedefs, global.config, global.rlp, global.utilAddress, global.EventEmitter, global.transportHttp, global.sha3, global.utilTemplate, global.types));
})(this, (function (exports, logger, utilInvariant, uuid, typedefs, config, rlp, utilAddress, EventEmitter, transportHttp, sha3, utilTemplate, types) { 'use strict';
