...
import { httpTransport, send as send$1 } from '@onflow/transport-http';
...
async function createGlobalContext() {
  ...
  return {
    ...
    get accessNodeUrl() {
      ...
      invariant$1(!!accessNodeUrl, `Either opts.node or "accessNode.api" in config must be defined.`);
