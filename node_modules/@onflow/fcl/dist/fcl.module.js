import { execStrategy, normalizePollingResponse, pluginRegistry, createFlowClientCore, buildMessageHandler, serviceEndpoint, CORE_STRATEGIES, getExecHttpPost, getCurrentUser, getMutate, initServiceRegistry } from '@onflow/fcl-core';
export { AppUtils, InteractionTemplateUtils, TestUtils, TransactionError, VERSION, WalletUtils, account, arg, args, atBlockHeight, atBlockId, authorization, authorizations, block, build, cadence, cdc, config, createSignableVoucher, decode, discovery, display, events, flowEmulator, flowMainnet, flowTestnet, getAccount, getBlock, getBlockHeader, getChainId, getCollection, getEvents, getEventsAtBlockHeightRange, getEventsAtBlockIds, getNetworkParameters, getNodeVersionInfo, getTransaction, getTransactionStatus, invariant, isBad, isOk, limit, nodeVersionInfo, param, params, payer, ping, pipe, pluginRegistry, proposer, query, queryRaw, ref, sansPrefix, script, send, serialize, subscribe, subscribeEvents, subscribeRaw, t, transaction, tx, validator, verifyUserSignatures, voucherIntercept, voucherToTxId, why, withPrefix } from '@onflow/fcl-core';
import { config } from '@onflow/config';
import { invariant } from '@onflow/util-invariant';
import { uid } from '@onflow/util-uid';
import * as fclWc from '@onflow/fcl-wc';
import { getProvider, createSessionProposal, request, FLOW_METHODS } from '@onflow/fcl-wc';
...
export { LOCAL_STORAGE, SESSION_STORAGE, authenticate, authz, createFlowClient, currentUser, logIn, mutate, reauthenticate, signUp, unauthenticate };
