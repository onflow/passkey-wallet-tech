...
function themeModeVariables() {
  var _a5;
  const themeMode = (_a5 = ThemeCtrl.state.themeMode) != null ? _a5 : "dark";
...
var WcmModalRouter = class extends LitElement {
  ...
  disconnectedCallback() {
    ...
    (_b4 = this.resizeObserver) == null ? void 0 : _b4.disconnect();
  }
  get routerEl() {
...
var WcmWalletButton = class extends LitElement {
  ...
  render() {
    var _a5;
    return html`<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${ifDefined(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${(_a5 = this.label) != null ? _a5 : UiUtil.getWalletName(this.name, true)}</wcm-text>${this.sublabelTemplate()}</div></button>`;
  }
};
...
var WcmWalletImage = class extends LitElement {
  ...
  render() {
    var _a5;
    const src = ((_a5 = this.imageUrl) == null ? void 0 : _a5.length) ? this.imageUrl : UiUtil.getWalletIcon({ id: this.walletId, image_id: this.imageId });
...
var WcmThemeContext = class extends LitElement {
  ...
  disconnectedCallback() {
    var _a5;
    (_a5 = this.unsubscribeTheme) == null ? void 0 : _a5.call(this);
  }
};
...
var WcmConnectorWaiting = class extends LitElement {
  ...
  svgLoaderTemplate() {
    ...
    const DH_ARRAY = 317;
    const DH_OFFSET = 425;
    const radius = (_b4 = (_a5 = ThemeCtrl.state.themeVariables) == null ? void 0 : _a5["--wcm-wallet-icon-large-border-radius"]) != null ? _b4 : ThemeUtil.getPreset("--wcm-wallet-icon-large-border-radius");
    let numRadius = 0;
    if (radius.includes("%")) {
...
var DataUtil = {
  manualWallets() {
    ...
    const recentWalletId = (_a5 = DataUtil.recentWallet()) == null ? void 0 : _a5.id;
    ...
    return (_b4 = CoreUtil.isMobile() ? wallets == null ? void 0 : wallets.map(({ id, name, links }) => ({ id, name, mobile: links, links })) : wallets == null ? void 0 : wallets.map(({ id, name, links }) => ({ id, name, desktop: links, links }))) != null ? _b4 : [];
  },
  recentWallet() {
  ...
  recomendedWallets(skipRecent = false) {
    var _a5;
    const recentWalletId = skipRecent ? void 0 : (_a5 = DataUtil.recentWallet()) == null ? void 0 : _a5.id;
    const { recomendedWallets } = ExplorerCtrl.state;
...
var WcmModal = class extends LitElement {
  ...
  disconnectedCallback() {
    var _a5;
    (_a5 = this.unsubscribeModal) == null ? void 0 : _a5.call(this);
  }
  get overlayEl() {
    ...
    window.addEventListener(
      ...
      (event) => {
        ...
        if (event.key === "Escape") {
          ...
          if (!((_a5 = event.target) == null ? void 0 : _a5.tagName.includes("wcm-"))) {
...
var WcmWalletExplorerView = class extends LitElement {
  ...
  disconnectedCallback() {
    var _a5;
    (_a5 = this.intersectionObserver) == null ? void 0 : _a5.disconnect();
  }
  // -- private ------------------------------------------------------ //
  get placeholderEl() {
  ...
  async fetchWallets() {
    ...
    if (!this.endReached && (this.firstFetch || total > PAGE_ENTRIES && listings.length < total)) {
      try {
        this.loading = true;
        const chains = (_a5 = OptionsCtrl.state.chains) == null ? void 0 : _a5.join(",");
...
lit-html/development/directives/if-defined.js:
   ...
   *)
*/
//# sourceMappingURL=dist-F6M5TFJJ.js.map
